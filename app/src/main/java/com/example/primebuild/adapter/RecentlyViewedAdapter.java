package com.example.primebuild.adapter;
...
import com.example.primebuild.ProductDetails;
import com.example.primebuild.model.RecentlyViewed;
import com.example.primebuild.R;
...
public class RecentlyViewedAdapter extends RecyclerView.Adapter<RecentlyViewedAdapter.RecentlyViewedHolder> {
    ...
    @Override
    public void onBindViewHolder(@NonNull RecentlyViewedHolder holder, @SuppressLint("RecyclerView") final int position) {
